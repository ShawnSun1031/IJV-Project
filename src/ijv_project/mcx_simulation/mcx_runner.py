...
class MCXRunner:
    ...
    Example:
        ...
        >>> from ijv_project.mcx_simulation.schema import MCXConfig
        >>> from ijv_project.mcx_simulation.schema.mcxlab import OpticalProperties, DetectorPosition
        >>> import numpy as np
        ...
        ...     ]
        ... )
        >>> sds_detid_map = {"1.0": [1], "2.0": [2]}
        >>> # Run simulation
        >>> runner = MCXRunner(config, sds_detid_map)
